...
class MultitaskingButton @Inject constructor(@ApplicationContext private val context: Context) : AssistiveButtonDelegate {
    ...
    override fun action(delegate: FloatingWindowDelegate, buttonModel: ButtonModelInPanel) {
        ...
        SmartButtonAccessibilityService.accessibilityInstance?.performGlobalAction(GLOBAL_ACTION_RECENTS)
    }
}